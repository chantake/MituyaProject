...
public class BroadcastChannel {
    ...
    /**
     *
     * @return The number of bits used by the channel. This value automatically changes according to attached receivers and transmitters.
     */
    ...
    /**
     * Transmits 1 bit over this channel to all receivers. The transmission can set any bit of the channel bit set. To set the 1st bit position should be 0.
     *
    ...
    public boolean checkChanPermissions(CommandSender sender, boolean admin) {
        ...
        return ((Player)sender).hasPermission("redstonechips.channel.admin") || owners.contains(playerName.toLowerCase()) || (admin ? false : users.contains(playerName.toLowerCase()));
    }
}
