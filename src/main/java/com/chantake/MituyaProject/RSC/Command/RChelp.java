...
public class RChelp extends RCCommand {
    ...
    public static String getCommandHelp(String command, com.chantake.MituyaProject.RSC.RedstoneChips rc) {
    ...
    public static void printCommandHelp(CommandSender sender, String command, com.chantake.MituyaProject.RSC.RedstoneChips rc) {
