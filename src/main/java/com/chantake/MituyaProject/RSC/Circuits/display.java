...
public class display extends Circuit {
    ...
    public void inputChange(int inIdx, boolean state) {
        ...
        if (ram == null) {
            ...
            if (hasListeners()) {
                debug("Moving to ram page " + ramPage);
            }
    ...
    protected boolean init(CommandSender sender, String[] args) {
        ...
        try {
            ...
            if (ram != null) {
                ramPageLength = screen.getDescription().addrWidth * screen.getDescription().addrHeight;
            }
            ...
            if (ram != null) {
                info(sender, "Reading pixel data from memory: " + ram.getId());
            }
        }
        catch (IllegalArgumentException ie) {
