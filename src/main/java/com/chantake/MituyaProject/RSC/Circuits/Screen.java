...
public class Screen {
    ...
    public void setColorIndex(byte[] index) {
        ...
        if (colorIndex == null) {
            ...
            colorLength = calculateBitLength(colorIndex.length);
        }
    }
    ...
    public static ScreenDescription scanScreen(Location l0, Location l1) {
        ...
        if (dx == 0 && dy != 0 && dz != 0) { // zy plane
            ...
            if (world.getBlockTypeIdAt(x1 + 1, y1, z1) == Material.WOOL.getId()) {
                ...
                throw new IllegalArgumentException("Can't find origin wool block.");
            }
            ...
            throw new IllegalArgumentException("Both interface blocks must be on the same plane.");
        }
