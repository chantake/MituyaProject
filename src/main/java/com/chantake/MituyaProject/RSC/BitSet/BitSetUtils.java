...
public class BitSetUtils {
    ...
    /**
     * Convert a BitSet to a binary representation string. Each bit is converted into "0" or "1" and added to the string. The result is a binary number with its
    ...
    /**
     * Convert a BitSet to a binary representation string. Converting each bit into "0" or "1". The result is a binary number with its most significant bit on
     * the left.
     *
     * @param b BitSet to convert
     * @param startBit Start converting from this bit. Treat it as the least significant bit.
    ...
    /**
     * Converts a string into a BitSet. The first character is the most significant bit. a '1' character is converted to true. Every other character is
     * converted to false.
     *
    ...
    /**
     * Shifts bits of a BitSet object one place to the left. Stores new value in the same BitSet.
     *
    ...
    /**
     * Shifts bits of a BitSet object one place to the right. Stores new value in the same BitSet.
     *
     * @param s Shifted BitSet object.
     * @param length Length of binary number.
    ...
    /**
     * Stores a BitSet object as a string in a map. Used for state persistence. Basically converts the BitSet into a string of "1" and "0" according to its bit
     * values.
     *
