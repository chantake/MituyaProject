...
public class SkyLandChunkGenerator extends org.bukkit.generator.ChunkGenerator {
    ...
    public List<BlockPopulator> getDefaultPopulators(org.bukkit.World world) {
        ArrayList populators = new ArrayList();
    ...
    private void decorateLand(int chunkX, int chunkZ, byte[] blocks, SkyLandChunkGenerator.BiomeGrid biomes) {
        double d0 = 0.03125D;
    ...
    @Override
    public byte[][] generateBlockSections(org.bukkit.World world, Random random, int chunkX, int chunkZ, SkyLandChunkGenerator.BiomeGrid biomes) {
